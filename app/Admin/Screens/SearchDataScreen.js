...
`
export class A_SearchPostScreen extends Component {
    ...
    _handle(postid) {
        this.props.navigation.navigate('A_Detail', { postid: postid });
    }
    _fetchMore = () => {
...
export class A_SearchCommentScreen extends Component {
